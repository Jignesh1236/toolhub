...
export const tools: Tool[] = [
  ...
  {
    id: 'text-share',
    name: 'Text Share Tool',
    category: 'utilities',
    description: 'Text share karo QR code ke saath. Text save ho jaati hai aur view count track hota hai',
    icon: 'fas fa-file-alt',
    route: '/tools/text-share',
    color: 'blue',
  },
  {
    id: 'pdf-merger',
  ...
  },
  {
    ...
    name: 'Photo Filters',
    category: 'media',
    description: 'Apply Instagram-style filters and effects to photos',
    icon: 'fas fa-filter',
    route: '/tools/photo-filters',
    color: 'pink',
  },
  {
    ...
    category: 'media',
    description: 'Remove backgrounds from photos automatically',
    icon: 'fas fa-cut',
  ...
  },
  {
    ...
    name: 'Photo Cropper',
    category: 'media',
    description: 'Crop photos to custom sizes and aspect ratios',
    icon: 'fas fa-crop',
    route: '/tools/photo-cropper',
    color: 'amber',
  },
  {
    id: 'photo-compressor',
    ...
    category: 'media',
    description: 'Compress photos to reduce file size without losing quality',
    icon: 'fas fa-compress',
    route: '/tools/photo-compressor',
    color: 'violet',
  },
  {
    id: 'photo-border',
    name: 'Photo Border Tool',
    category: 'media',
    description: 'Add decorative borders and frames to photos',
    icon: 'fas fa-border-all',
    route: '/tools/photo-border',
    color: 'slate',
  },
  {
    id: 'photo-text-overlay',
    name: 'Photo Text Overlay',
    category: 'media',
    description: 'Add custom text, quotes, and captions to photos',
    icon: 'fas fa-font',
    route: '/tools/photo-text-overlay',
    color: 'cyan',
  },
  ...
  },
  {
    ...
    name: 'PDF Splitter',
    category: 'converters',
    description: 'Split large PDF files into separate pages or sections',
  ...
  },
  {
    ...
    category: 'content',
    description: 'Create professional digital business cards with custom designs',
    icon: 'fas fa-id-card',
    route: '/tools/business-card-generator',
    color: 'teal',
  },
  {
    id: 'resume-builder',
