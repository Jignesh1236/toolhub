...
import PhotoFilters from "@/pages/tools/photo-filters";
import PDFSplitter from "@/pages/tools/pdf-splitter";

// Recently added photo editing tools
import BackgroundRemover from "@/pages/tools/background-remover";
import PhotoCollage from "@/pages/tools/photo-collage";
import PhotoCropper from "@/pages/tools/photo-cropper";
import PhotoCompressor from "@/pages/tools/photo-compressor";
import PhotoBorder from "@/pages/tools/photo-border";
import PhotoTextOverlay from "@/pages/tools/photo-text-overlay";

// Recently added PDF tools
import PDFCompressor from "@/pages/tools/pdf-compressor";
import PDFPasswordProtect from "@/pages/tools/pdf-password-protect";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/tools/pdf-password-protect" component={PDFPasswordProtect} />
      ...
      <Route path="/tools/photo-filters" component={PhotoFilters} />
      
      {/* Photo Editing Tools */}
      <Route path="/tools/background-remover" component={BackgroundRemover} />
      <Route path="/tools/photo-collage" component={PhotoCollage} />
      <Route path="/tools/photo-cropper" component={PhotoCropper} />
      <Route path="/tools/photo-compressor" component={PhotoCompressor} />
      <Route path="/tools/photo-border" component={PhotoBorder} />
      <Route path="/tools/photo-text-overlay" component={PhotoTextOverlay} />
      ...
      <Route path="/tools/business-card-generator" component={BusinessCardGenerator} />
